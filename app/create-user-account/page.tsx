...
import { createUserSchema, AccountFormValues, accountDefaultValues } from '@/schema/create-user-account-schema';
                      ...
                      >
                        ...
                        {fileRejections.length > 0 && (
                          <p className="mt-2 text-red-500 text-xs">
                            {fileRejections[0].errors[0].message === 'File type must be image/jpeg, image/jpg, image/png' 
